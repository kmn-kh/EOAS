...
$img_student = $_FILES['img_student']['name'];
    ...
    $khmer_card = $_FILES['khmer_card']['name'];
$latang= $_POST['latang'];
...
move_uploaded_file($_FILES['khmer_card']['tmp_name'], $upload_dir . $khmer_card);
...
$sql = "INSERT INTO table_form (id,first_name, last_name, sex, dob, address,
 ...
 number_table,img_student,birth_certificate,img_score,certificate,	latang,department,date_bacll,num_certificate,skill_one,skill_two,num_personal,province,grade_stu,khmer_card,grade)
...
'$certificate','$latang','$department','$date_bacll','$num_certificate','$skill_one','$skill_two','$num_personal','$province','$grade_stu','$khmer_card','$grade')";
