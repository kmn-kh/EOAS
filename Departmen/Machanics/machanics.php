...
<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
    <div class="data-content">
        <?php
        $vid_top = "SELECT * FROM macha_vidtop";
    ...
    <div id="carouselExampleControlsNoTouching" class="carousel slide carousel-fade" data-bs-touch="false"
        ...
        <div class="carousel-inner">
            ...
            <?php
            $i = 0;
            $database = "SELECT * FROM macha_videobutton";
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="member d-flex align-items-start">
                                ...
                                <div class="member-info">
                                    ...
                                    <br>
                                    <!-- Read more -->
                                    <button class="showmore"><a href="./macha_staff_readmore.php?id=<?= $row['id']; ?>">Show more</a></button>
                                </div>
                            </div>
                        </div>
