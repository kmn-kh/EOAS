    ...
    <div class="detil">
        ...
        <div id="myModal_content" class="conmodal">
            <div class="conmodal_staff">
                ...
                <div class="more">
                    <div class="video_top">
                        <form action="Process/process_food_staff_info.php" method="post" enctype="multipart/form-data"
                            class="formstaff">
        ...
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT img FROM food_staff_info WHERE id ='" . $id . "'";
            $result = $staff_conn->query($sql);
            if ($result->num_rows > 0) {
                $row = $result->fetch_assoc();
                $file_name = $row['img'];
                $file_path = 'img/food/' . $file_name; // Update the path to your file directory
                ...
                $sql = "DELETE FROM food_staff_info WHERE id ='" . $id . "'";
        ...
        <table class="stafftab" cellspacing="0">
            ...
            <?php
            $staff_data = "SELECT * FROM food_staff_info";
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mt-4 center">
                                                <div class="member d-flex align-items-start">
                                                    <div class="teampic">
                                                        <img src="img/food/<?= $info_result['img']; ?>" class="img-fluid"
                                                            alt="staff1">
                                                    </div>
