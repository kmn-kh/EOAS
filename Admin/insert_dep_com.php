    ...
    <div class="detil">
        <div class="addvidtop">
            ...
            <div id="myModal_content" class="conmodal">
                <div class="conmodal-content">
                    ...
                    <div class="more">
                        <div class="video_top">
                            <form action="Process/process_com_videotop.php" method="POST">
                                <h5>Link Top</h5>
            ...
            <div class="staff-view-depvidtop">
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $delet = "DELETE FROM com_vidtop WHERE id ='" . $id . "'";
                ...
                <table border="0" cellspacing="0">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo ' <td><a href="insert_dep_com.php?id=' . $row['id'] . '">Delete</a></td>';
                            echo "</tr>";
                            $count++;
                        }
                    } else {
        ...
        <div class="addvidtop">
                ...
                <div class="conmodal-contentcon">
                    ...
                    <div class="more">
                        <div class="content cone">
                            <form action="Process/process_com_content.php" method="POST">
                                <h5>ចំណងជើង</h5>
            ...
            <div class="staff-view-depcontent">
                ...
                if (isset($_GET['id'])) {
                    $id_con = $_GET['id'];
                    $delet_con = "DELETE FROM com_data WHERE id ='" . $id_con . "'";
        ...
        <div class="addvidtop">
                ...
                <div class="conmodal-contentbut">
                    ...
                    <div class="more">
                        <div class="video_button">
                            <form action="Process/process_com_videobutton.php" method="POST">
                                <h5>Link1</h5>
            ...
            <div class="staff-view-depvidbut">
                ...
                if (isset($_GET['id'])) {
                    $id_but = $_GET['id'];
                    $delet_but = "DELETE FROM com_videobutton WHERE id ='" . $id_but . "'";
                ...
                $sql_but = "SELECT * FROM com_videobutton";
                ...
                <table border="0" cellspacing="0" class="linkbut">
                    ...
                    if (mysqli_num_rows($result_but) > 0) {
                        while ($row = $result_but->fetch_assoc()) {
                            ...
                            echo ' <td><a id="dele" href="insert_dep_com.php?id=' . $row['id'] . '">Delete</a></td>';
                            echo "</tr>";
                            $count_but++;
                        }
                    } else {
